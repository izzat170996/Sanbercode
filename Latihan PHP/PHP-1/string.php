...
<body>
    ...
    <?php   
        ...
        */
        ...
        $pangjang_String2 = strlen($second_sentence);
        $jumlah_Kata2 = str_word_count ($second_sentence);
        echo "Panjang string first_sentence: $panjang_String1 , jumlah kata: $jumlah_Kata1";
        echo "<br>";
        echo "Panjang string second_sentence : $pangjang_String2 , jumlah kata: $jumlah_Kata2";
